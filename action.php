		...
		if($count > 0){
			...
			if(mysqli_query($con,$sql)){
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Product is Added! Continue Shopping...</b>
					</div>
				";
			}
		}
			...
			if (mysqli_query($con,$sql)) {
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Your product is Added Successfully! Continue Shopping...</b>
					</div>
				";
				exit();
			}
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3">RM'.$product_price.'</div>
					</div>';
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@rad.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/rad/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/rad/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/rad/cancel.php"/>
